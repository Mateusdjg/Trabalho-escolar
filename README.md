...
O sistema de controle de vendas é uma página web desenvolvida com as seguintes tecnologias HTML, CSS, TypeScript e JavaScript. Ele foi projetado para apenas a proprietária usar.
